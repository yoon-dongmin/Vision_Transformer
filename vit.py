...
if __name__ == "__main__":
    ...
    parser.add_argument('--latent_vec_dim', default=128, type=int, help='latent dimension') #처음에 사용되는 linear projection의 dimension
    ...
    mlp_hidden_dim = int(latent_vec_dim/2) #임의로 설정
